...
class Library:
    def __init__(self):
        ...
        self.books_available: Dict[str: List[str]] = {}  # {"author name": ["book A", "book B"...]
        self.rented_books: Dict[str: Dict[str:int]] = {}  # {"book name": {"user borrowed", days left...}
    ...
    def return_book(self, author: str, book_name: str, user: User) -> str:
        if book_name in self.rented_books.keys():
            self.rented_books.pop(book_name)
