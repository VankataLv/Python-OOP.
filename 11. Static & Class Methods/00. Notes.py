# @ првави метода статичен, метода не знае нищо за класа или за инстанцията
# те не приемат self, немогат да модифицират нито инстанциаята нито класа, но понеже се отнасят към класа като логика \
#   заради това се пишат вътре
